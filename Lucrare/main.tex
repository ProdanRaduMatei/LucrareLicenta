...
\begin{titlepage}
    \centering
    \textbf{\LARGE BABEȘ-BOLYAI UNIVERSITY}\\[0.3cm]
    \textbf{\Large FACULTY OF MATHEMATICS AND COMPUTER SCIENCE}\\[0.3cm]
    \textbf{\large MATHEMATICS AND COMPUTER SCIENCE (ENGLISH)}\\[4cm]

    {\huge\bfseries BACHELOR'S THESIS}\\[1.5cm]
    {\Huge\bfseries SeatSurfer: A Database-Centric Seat Management System}\\[4cm]

    \begin{flushleft}
        \textbf{Scientific Supervisor:}\\
        Lecturer PhD Emilia-Loredana Pop
    \end{flushleft}
...
\begin{titlepage}
    \centering
    \textbf{\LARGE UNIVERSITATEA BABEȘ-BOLYAI}\\[0.3cm]
    \textbf{\Large FACULTATEA DE MATEMATICĂ ȘI INFORMATICĂ}\\[0.3cm]
    \textbf{\large SPECIALIZAREA MATEMATICĂ- INFORMATICĂ (ENGLEZĂ)}\\[4cm]

    {\huge\bfseries LUCRARE DE LICENȚĂ}\\[1.5cm]
    {\Huge\bfseries SeatSurfer: Un Sistem de Gestiune a Locurilor Bazat pe Baze de Date}\\[4cm]

    \begin{flushleft}
        \textbf{Coordonator Științific:}\\
        Lect. Dr. Emilia-Loredana Pop
    \end{flushleft}
